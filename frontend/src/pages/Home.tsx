  ...
  return (
    <>
      <main className="flex h-full w-full">
        ...
        <div className="flex flex-col min-h-screen gap-3 w-full px-4 md:px-8 lg:ml-16">
            <Button
                variant="floating"
                size="icon"
            ...
            <div className="flex-grow flex flex-col justify-center items-center">
                <h1 className="scroll-m-20 leading-tight text-3xl md:text-4xl lg:text-5xl font-extrabold tracking-tight">
                    Welcome to Travel-Amigo
                </h1>
                <h2 className="scroll-m-20 pb-2 text-xl md:text-2xl lg:text-3xl font-semibold tracking-tight mt-6 md:mt-8 lg:mt-10 transition-colors">
